...
function showSection(section) {
  ...
  const titles = { jogadores: 'Jogadores', 'player-detail': 'Detalhes do Jogador', games: 'Minhas Partidas', viewer: 'Visualizador', books: 'Livros', puzzles: 'Puzzles', videos: 'Vídeos' };
